...
export const apiConfig = {
  ...
  endpoints: {
    ...
    assignManagerToOrder: (orderId: string, managerId: string) => `/api/orders/${orderId}/assign-manager/${managerId}`,
    ...
    customerOrders: (customerId: string) => `/api/customers/${customerId}/orders`,
